...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GradingState);
}
...
/// @nodoc
class $GradingStateCopyWith<$Res>  {
$GradingStateCopyWith(GradingState _, $Res Function(GradingState) __);
}


/// Adds pattern-matching-related methods to [GradingState].
extension GradingStatePatterns on GradingState {
...
class _Initial implements GradingState {
  const _Initial();
...
class _Loading implements GradingState {
  const _Loading();
...
class _Success implements GradingState {
  const _Success();
...
class _Error implements GradingState {
...
@override
String toString() {
  return 'GradingState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $GradingStateCopyWith<$Res> {
