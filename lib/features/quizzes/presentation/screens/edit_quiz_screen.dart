      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12.r), borderSide: const BorderSide(color: Color(0xFF26C6DA))),
          ),
        ),
      ],
    );
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(color: fillColor, borderRadius: BorderRadius.circular(12.r)),
          child: Row(
