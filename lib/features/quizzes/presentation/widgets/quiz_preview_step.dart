              ...
              BlocConsumer<QuizGradingCubit, QuizGradingState>(
                ...
                builder: (context, state) {
                  ...
                  return ElevatedButton(
                    ...
                    child: isLoading 
                      ? SizedBox(width: 16.w, height: 16.w, child: CircularProgressIndicator(strokeWidth: 2, color: ColorsManager.white))
                      : Row(
                          children: [
                            Text(
                              'Publish Quiz',
                            ...
                            SizedBox(width: 8.w),
                            Icon(Icons.rocket_launch, color: ColorsManager.white, size: 16.sp),
                          ],
                        ),
                  );
                },
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(icon, color: const Color(0xFF26C6DA), size: 20.sp),
          ),
          SizedBox(width: 12.w),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
