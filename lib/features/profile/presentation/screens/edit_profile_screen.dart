        ...
        builder: (context, state) {
          if (state is ProfileLoading) {
            ...
            return SingleChildScrollView(
              padding: EdgeInsets.symmetric(horizontal: AppSizes.horizontalPadding.w, vertical: 24.h),
              child: Column(
                ...
                children: [
                        ...
                        child: CircleAvatar(
                          ...
                          child: ClipOval(
                            child: _selectedImage != null
                                ? Image.file(_selectedImage!, width: 108.r, height: 108.r, fit: BoxFit.cover)
                                : (profile.profilePictureUrl != null && profile.profilePictureUrl!.isNotEmpty
                                    ? Image.network(
                                        ...
                                        height: 108.r,
                                        fit: BoxFit.cover,
                                        errorBuilder: (context, error, stackTrace) => Image.asset(ImagesManager.profileImage, width: 108.r, height: 108.r, fit: BoxFit.cover),
                                      )
                                    : Image.asset(ImagesManager.profileImage, width: 108.r, height: 108.r, fit: BoxFit.cover)),
                          ),
                        ),
                      ),
                      GestureDetector(
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.info_outline, color: ColorsManager.blue, size: 20.sp),
                        SizedBox(width: 8.w),
                        Expanded(
                          child: Text(
