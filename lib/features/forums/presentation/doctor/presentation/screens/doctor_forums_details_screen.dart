...
class DoctorForumsDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: _DoctorForumsDetailsBody(courseName: courseName, courseId: courseId),
    );
  }
}

class _DoctorForumsDetailsBody extends StatefulWidget {
  final String courseName;
  final int courseId;

  const _DoctorForumsDetailsBody({required this.courseName, required this.courseId});

  @override
  State<_DoctorForumsDetailsBody> createState() => _DoctorForumsDetailsBodyState();
}

class _DoctorForumsDetailsBodyState extends State<_DoctorForumsDetailsBody> {
