    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          courseName,
          style:
              headlineStyle.copyWith(fontWeight: FontWeight.bold, fontSize: 16.sp),
    ...
    return Column(
      children: [
        ...
        Text(
          label,
          style:
              TextStyle(fontSize: 12.sp, color: ColorsManager.grayMedium),
        ),
      ],
    );
  }
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  time,
                  style: TextStyle(
                      fontSize: 11.sp, color: ColorsManager.grayMedium),
                ),
              ],
            ),
          ),
